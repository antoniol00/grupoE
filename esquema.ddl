CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, DTYPE VARCHAR(31), CARACTER VARCHAR, CODIGO INTEGER NOT NULL, CREDITOS_PRACTICOS DOUBLE NOT NULL, CREDITOS_TEORICOS DOUBLE NOT NULL, CUATRIMESTRE INTEGER, CURSO INTEGER, DURACION INTEGER, IDIOMAS VARCHAR, NOMBRE VARCHAR NOT NULL, OFERTADA BOOLEAN NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (REFERENCIA))
...
CREATE TABLE CLASE (HORA_INICIO VARCHAR NOT NULL, DIA VARCHAR NOT NULL, HORA_FIN VARCHAR NOT NULL, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID VARCHAR(10) NOT NULL, PRIMARY KEY (HORA_INICIO, DIA, GRUPO_ID))
