...
CREATE TABLE OPTATIVA (CODIGO INTEGER NOT NULL, MENCION VARCHAR, PLAZAS INTEGER, PRIMARY KEY (CODIGO))
...
ALTER TABLE OPTATIVA ADD CONSTRAINT FK_OPTATIVA_CODIGO FOREIGN KEY (CODIGO) REFERENCES ASIGNATURA (CODIGO)
