CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, DTYPE VARCHAR(31), CODIGO INTEGER NOT NULL, CREDITOS_PRACTICOS DOUBLE NOT NULL, CREDITOS_TEORICOS DOUBLE NOT NULL, CUATRIMESTRE INTEGER, CURSO INTEGER, IDIOMAS VARCHAR, NOMBRE VARCHAR NOT NULL, OFERTADA BOOLEAN NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (REFERENCIA, TITULACION_CODIGO))
CREATE TABLE OPTATIVA (REFERENCIA INTEGER NOT NULL, MENCION VARCHAR, PLAZAS INTEGER, PRIMARY KEY (REFERENCIA))
...
CREATE TABLE EXPEDIENTE (NUMERO INTEGER NOT NULL, ACTIVO BOOLEAN, CREDITOS_FB INTEGER, CREDITOS_OB INTEGER, CREDITOS_PE INTEGER, CREDITOS_TF INTEGER, NOTA_MEDIA DOUBLE, ALUMNO_DNI VARCHAR(9) NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (NUMERO))
CREATE TABLE ENCUESTA (FECHA_ENVIO DATE NOT NULL, EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (FECHA_ENVIO, EXPEDIENTE))
CREATE TABLE GRUPOS_ASIG (CURSO VARCHAR(5) NOT NULL, OFERTA VARCHAR(10), REFERENCIA INTEGER NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, GRUPO_ID VARCHAR(10) NOT NULL, PRIMARY KEY (CURSO, REFERENCIA, TITULACION_CODIGO, GRUPO_ID))
...
CREATE TABLE GRUPO (ID VARCHAR(10) NOT NULL, ASIGNAR VARCHAR, CURSO INTEGER NOT NULL UNIQUE, INGLES BOOLEAN NOT NULL, LETRA VARCHAR(1) NOT NULL UNIQUE, PLAZAS INTEGER, TURNO VARCHAR(6) NOT NULL, VISIBLE BOOLEAN, GRUPO_ID VARCHAR(10), TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE ASIGNA_GRUPOS (REFERENCIA INTEGER NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, GRUPO_ID VARCHAR(10), CURSO VARCHAR(10) NOT NULL, EXPEDIENTE_NUMERO INTEGER NOT NULL, PRIMARY KEY (REFERENCIA, TITULACION_CODIGO, CURSO, EXPEDIENTE_NUMERO))
CREATE TABLE CLASE (HORA_INICIO VARCHAR NOT NULL, DIA VARCHAR NOT NULL, HORA_FIN VARCHAR NOT NULL, TITULACION_CODIGO INTEGER NOT NULL, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID VARCHAR(10) NOT NULL, PRIMARY KEY (HORA_INICIO, DIA, GRUPO_ID))
...
ALTER TABLE GRUPOS_ASIG ADD CONSTRAINT FK_GRUPOS_ASIG_REFERENCIA FOREIGN KEY (REFERENCIA, TITULACION_CODIGO) REFERENCES ASIGNATURA (REFERENCIA, TITULACION_CODIGO)
...
ALTER TABLE ASIGNA_GRUPOS ADD CONSTRAINT FK_ASIGNA_GRUPOS_REFERENCIA FOREIGN KEY (REFERENCIA, TITULACION_CODIGO) REFERENCES ASIGNATURA (REFERENCIA, TITULACION_CODIGO)
ALTER TABLE CLASE ADD CONSTRAINT FK_CLASE_GRUPO_ID FOREIGN KEY (GRUPO_ID) REFERENCES GRUPO (ID)
ALTER TABLE CLASE ADD CONSTRAINT FK_CLASE_ASIGNATURA_REFERENCIA FOREIGN KEY (ASIGNATURA_REFERENCIA, TITULACION_CODIGO) REFERENCES ASIGNATURA (REFERENCIA, TITULACION_CODIGO)
...
ALTER TABLE ENCUESTA_GRUPOS ADD CONSTRAINT FK_ENCUESTA_GRUPOS_CURSO FOREIGN KEY (CURSO, ASIGNATURA, TITULACION, GRUPO) REFERENCES GRUPOS_ASIG (CURSO, REFERENCIA, TITULACION_CODIGO, GRUPO_ID)
