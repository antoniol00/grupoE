...
CREATE TABLE GRUPO (ID VARCHAR(10) NOT NULL, ASIGNAR VARCHAR(255), CURSO INTEGER NOT NULL UNIQUE, INGLES TINYINT(1) default 0 NOT NULL, LETRA VARCHAR(1) NOT NULL UNIQUE, PLAZAS INTEGER, TURNO VARCHAR(6) NOT NULL, VISIBLE TINYINT(1) default 0, GRUPO_ID_ID VARCHAR(10), TITULACION_CODIGO INTEGER NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE ASIGNA_GRUPOS (ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID_ID VARCHAR(10), CURSO VARCHAR(10) NOT NULL, EXPEDIENTE_NUMERO INTEGER NOT NULL, PRIMARY KEY (ASIGNATURA_REFERENCIA, CURSO, EXPEDIENTE_NUMERO))
CREATE TABLE CLASE (HORA_INICIO VARCHAR(255) NOT NULL, DIA VARCHAR(255) NOT NULL, HORA_FIN VARCHAR(255) NOT NULL, ASIGNATURA_REFERENCIA INTEGER NOT NULL, GRUPO_ID_ID VARCHAR(10) NOT NULL, PRIMARY KEY (HORA_INICIO, DIA, GRUPO_ID_ID))
